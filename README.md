...
<p align="center">
  <img src="pixqsl_noblack.svg" alt="PIXqsl icon" style="width: 192px" />
</p>
...
<p align="center">
  <a href="https://github.com/cleber-ps8pi/PIXqsl/releases/latest">
...
PIXqsl is a 100% free, libre, and privacy-respecting amateur radio logbook for Android.  
...
Designed for amateur radio operators who value privacy and security, PIXqsl keeps your certificates and logs safely on your device.
...
- Download the latest APK from the [Releases](https://github.com/cleber-ps8pi/PIXqsl/releases) page  
- F-Droid release will be available soon


## Build from Source

PIXqsl is written in Kotlin using Gradle Kotlin DSL.

```bash
git clone git@github.com:cleber-ps8pi/PIXqsl.git
cd PIXqsl
...
PIXqsl is licensed under the **GNU General Public License v3.0**.
...
* PIXqsl is an independent project and is not endorsed by ARRL.

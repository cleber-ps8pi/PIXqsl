                ...
                TopAppBar(
                    title = {
                        Box(
                            ...
                            // Logo (antenna + PIXqsl by Cleber)
                            Image(
                                painter = painterResource(R.drawable.pixqsl_header_logo),
                                contentDescription = "PIXqsl",
                                modifier = Modifier
                            ...
                            // Dotted map on the right
                            Image(
                                painter = painterResource(R.drawable.pixqsl_map),
